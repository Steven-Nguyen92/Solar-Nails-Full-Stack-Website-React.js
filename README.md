...
This is a full stack web application that was built from scratch for a small business. It is recomended to use [Visual Studio Code](https://code.visualstudio.com/) to view it's contents. 
